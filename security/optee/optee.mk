...
PRODUCT_COPY_FILES += \
	...
	vendor/rockchip/common/security/optee/lib/arm/keystore.odroidn1.so:system/lib/hw/keystore.odroidn1.so	\
	...
	vendor/rockchip/common/security/optee/lib/arm/gatekeeper.odroidn1.so:system/lib/hw/gatekeeper.odroidn1.so	
#endif
...
PRODUCT_COPY_FILES += \
	...
	vendor/rockchip/common/security/optee/lib/arm64/keystore.odroidn1.so:system/lib64/hw/keystore.odroidn1.so	\
	...
	vendor/rockchip/common/security/optee/lib/arm64/gatekeeper.odroidn1.so:system/lib64/hw/gatekeeper.odroidn1.so	
endif
endif
